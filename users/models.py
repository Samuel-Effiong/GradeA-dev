...
class CustomUser(AbstractUser):
    ...
    must_change_password = models.BooleanField(
        default=False,
        help_text=_(
            "True for an account whose current password was generated by "
            "the system (e.g. a school-license teacher invite) rather than "
            "chosen by the user. Not enforced server-side - the frontend "
            "reads this (see CustomUserSerializer) to show a nudge to "
            "change it."
        ),
    )
